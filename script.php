...
class plgtaskcgautoarchiveMenusInstallerScript
{
	private $min_joomla_version      = '4.0.0';
	private $min_php_version         = '7.2';
	private $name                    = 'Plugin CG AutoArchive Menus';
	private $exttype                 = 'plugin';
	private $extname                 = 'cgautoarchivemenus';
	private $previous_version        = '';
	private $dir           = null;
	private $installerName = 'plgtaskcgautoarchivemenusinstaller';
	...
	private function postinstall_cleanup() {
        ...
        $conditions = array(
            ...
            $db->qn('element') . ' = ' . $db->quote('cgautoarchivemenus')
        );
        ...
        try {
            ...
            JLog::add('unable to enable plugin cg autoarchive menus', JLog::ERROR, 'jerror');
        }
